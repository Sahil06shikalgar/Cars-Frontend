...
function BrandSvg({ size = 20, className = '', children, ...rest }) {
  return (
    <svg
      width={size}
      height={size}
...
export const HeartIcon = ({ filled, ...p }) => (
  <Svg {...p} fill={filled ? 'currentColor' : 'none'} strokeWidth={filled ? 0 : 2}>
...
export const StarIcon = ({ filled = true, ...p }) => (
  <Svg {...p} fill={filled ? 'currentColor' : 'none'} strokeWidth={filled ? 0 : 2}>
    <path d="m12 2 3.9 7.2 8.1 1.1-6 5.6 1.5 8-7.5-4.1-7.5 4.1 1.5-8-6-5.6 8.1-1.1Z" transform="translate(-.5 0)" />
  </Svg>
)
...
export const TrophyIcon = (p) => (
  <Svg {...p}>
    ...
    <path d="M6 5H3v3a4 4 0 0 0 4 4" />
    <path d="M18 5h3v3a4 4 0 0 1-4 4" />
    <path d="M12 15v5" />
    <path d="M9 21h6" />
  </Svg>
)
...
export const TagIcon = (p) => (
  <Svg {...p}>
    <path d="M12.5 2 21 10.5 12.5 19 4 10.5 12.5 2Z" />
    <path d="M4 10.5v-8h8" />
    <path d="M9.5 4.5a1 1 0 0 1 1 1" />
  </Svg>
)
...
export const CarIcon = (p) => (
  <Svg {...p}>
    <path d="M5 17h14" />
    <path d="m5 17-1.6-4.4a2 2 0 0 1 .2-1.7l2-3A2 2 0 0 1 7.3 7h9.4a2 2 0 0 1 1.7 1L20.4 11a2 2 0 0 1 .2 1.7L19 17" />
    <path d="M3 17v3h3v-1.5h12V20h3v-3" />
